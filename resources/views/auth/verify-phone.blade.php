...
@section('title') Verify Phone @endsection
@section('content')
            ...
            <div class="col-md-6 mt-4 mx-auto">
                ...
                <div class="card">
                    <div class="card-body shadow-lg rounded">
                        <p class="card-text">
                            {{ __('Thanks for signing up! Before getting started, could you verify your phone number by entering
                            the OTP that we just send to you? If you didn\'t receive the SMS, we will gladly send you another.') }}
                        </p>

                        @if (session('message') == 'invalid-otp')
                            <p class="card-text p-4 text-danger">
                                {{ __('The OTP is not valid!') }}
                            </p>
                        @endif
                    ...
                    <form class="mt-2" method="POST" action="{{ route('phone.verification.verify') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="otp" class="form-control" id="my-input" placeholder="Enter OTP">
                        </div>
